...
public class dal_Lich extends DBConnect{
        ...
        try{
            ...
            for(dto_Lich lich : dsLich){
                ...
                sql = "INSERT INTO lich_ngay(ma_lop,ma_gv,ma_phong, tg_bd, tg_kt) "
                        + "VALUES (?,?,?,to_date(?,'dd-mm-yyy hh24:mi:ss'),to_date(?,'dd-mm-yyy hh24:mi:ss'))";
                        */
    ...
    public static void main(String[] args){
        ...
        ArrayList<dto_Lich> ds = new ArrayList<dto_Lich>();
        ds = new dal_Lich().layDsLichTheoLop(5002);
        
        for(dto_Lich lich : ds){               
                System.out.println(lich.getMaLop());
                System.out.println(lich.getMaGv());
                System.out.println(lich.getMaPhong());
                System.out.println(lich.getNgayHoc());
                System.out.println(lich.getGioBd());
                System.out.println(lich.getGioKt()); 
        }
    }
}
